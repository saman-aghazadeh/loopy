...
#if INTENSITY1
	BBfunction (temp, (VTYPE)(B[i+1]), multiplier);
#elif INTENSITY2
	BBfunction2 (temp, (VTYPE)(B[i+1]), multiplier);
#elif INTENSITY3
	BBfunction3 (temp, (VTYPE)(B[i+1]), multiplier);
#elif INTENSITY4
	BBfunction4 (temp, (VTYPE)(B[i+1]), multiplier);
#elif INTENSITY5
	BBfunction5 (temp, (VTYPE)(B[i+1]), multiplier);
#endif
