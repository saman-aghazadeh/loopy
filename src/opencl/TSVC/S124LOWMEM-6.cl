...
#if INTENSITY1
		CCfunction(A[gid], B[gid], additive, multiplier);
#elif INTENSITY2
		CCfunction2(A[gid], B[gid], additive, multiplier);
#elif INTENSITY3
		CCfunction3(A[gid], B[gid], additive, multiplier);
#elif INTENSITY4
		CCfunction4(A[gid], B[gid], additive, multiplier);
#elif INTENSITY5
		CCfunction5(A[gid], B[gid], additive, multiplier);
#elif INTENSITY6
		CCfunction6(A[gid], B[gid], additive, multiplier);
#endif
...
#if INTENSITY1
		CCfunction(A[gid], C[gid], additive, multiplier);
#elif INTENSITY2
		CCfunction2(A[gid], C[gid], additive, multiplier);
#elif INTENSITY3
		CCfunction3(A[gid], C[gid], additive, multiplier);
#elif INTENSITY4
		CCfunction4(A[gid], C[gid], additive, multiplier);
#elif INTENSITY5
		CCfunction5(A[gid], C[gid], additive, multiplier);
#elif INTENSITY6
		CCfunction6(A[gid], C[gid], additive, multiplier);
#endif
...
#if INTENSITY1
		CCfunction(A_local, B_local, additive, multiplier);
#elif INTENSITY2
		CCfunction2(A_local, B_local, additive, multiplier);
#elif INTENSITY3
		CCfunction3(A_local, B_local, additive, multiplier);
#elif INTENSITY4
		CCfunction4(A_local, B_local, additive, multiplier);
#elif INTENSITY5
		CCfunction5(A_local, B_local, additive, multiplier);
#elif INTENSITY6
		CCfunction6(A_local, B_local, additive, multiplier);
#endif
...
#if INTENSITY1
		CCfunction(A_local, C_local, additive, multiplier);
#elif INTENSITY2
		CCfunction2(A_local, C_local, additive, multiplier);
#elif INTENSITY3
		CCfunction3(A_local, C_local, additive, multiplier);
#elif INTENSITY4
		CCfunction4(A_local, C_local, additive, multiplier);
#elif INTENSITY5
		CCfunction5(A_local, C_local, additive, multiplier);
#elif INTENSITY6
		CCfunction6(A_local, C_local, additive, multiplier);
#endif
