...
#elif INTENSITY3
	BBfunction3 (temp, (VTYPE)(B[i+9]), multiplier);
#elif INTENSITY4
	BBfunction4 (temp, (VTYPE)(B[i+9]), multiplier);
#elif INTENSITY5
	BBfunction5 (temp, (VTYPE)(B[i+9]), multiplier);
#endif
...
#if INTENSITY1
	Bfunction (BPrime[index+2], B[index+3], multiplier);	
#elif INTENSITY2
	Bfunction2 (BPrime[index+2], B[index+3], multiplier);	
#elif INTENSITY3
	Bfunction3 (BPrime[index+2], B[index+3], multiplier);	
#elif INTENSITY4
	Bfunction4 (BPrime[index+2], B[index+3], multiplier);	
#elif INTENSITY5
	Bfunction5 (BPrime[index+2], B[index+3], multiplier);	
#endif
