...
#define megaBfunction(A,B,C) AInit(A,B,C); OP##NUMFMAS(tempA,tempB,tempC); AFinal (A)
#define megaBfunction2(A,B,C) AInit(A,B,C); OP##NUMFMAS(tempA,tempB,tempC); OP##NUMFMAS(tempA,tempB,tempC); AFinal (A)
#define megaBfunction3(A,B,C) AInit(A,B,C); OP##NUMFMAS(tempA,tempB,tempC); OP##NUMFMAS(tempA,tempB,tempC); OP##NUMFMAS(tempA,tempB,tempC); AFinal (A)
#define megaBfunction4(A,B,C) AInit(A,B,C); OP##NUMFMAS(tempA,tempB,tempC); OP##NUMFMAS(tempA,tempB,tempC); OP##NUMFMAS(tempA,tempB,tempC); OP##NUMFMAS(tempA,tempB,tempC); AFinal(A)
