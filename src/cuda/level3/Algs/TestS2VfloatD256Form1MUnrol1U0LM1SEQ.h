#ifndef TestS2VfloatD256Form1MUnrol1U0LM1SEQ_H_
#define TestS2VfloatD256Form1MUnrol1U0LM1SEQ_H_

__global__ void TestS2VfloatD256Form1MUnrol1U0LM1SEQ( float *data, float *rands, int index, int rand_max){
	float2 temp;
...
void TestS2VfloatD256Form1MUnrol1U0LM1SEQ_wrapper (float *data, float *rands, int index, int rand_max, int numBlocks, int threadPerBlock) {
	TestS2VfloatD256Form1MUnrol1U0LM1SEQ<<<numBlocks, threadPerBlock>>> (data, rands, index, rand_max);
}
